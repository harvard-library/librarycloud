 ...
 */   
    ...
    /*
    private Item getItem(String rec) {
    	Item item = new Item();
    	item.setModsType(rec);
    	return item;
    }
     */
   

    public ModsType getModsType() throws JAXBException {
