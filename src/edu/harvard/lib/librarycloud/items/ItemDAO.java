          ...
          // ignore
            ...
            if (f.equals("dateRange")) {
              try {
                ...
                Date start = (queryParams.containsKey("facet.range.start")) ? formatter.parse(queryParams.getFirst("facet.range.start")) : new Date(Long.MIN_VALUE);
                Date end = (queryParams.containsKey("facet.range.end")) ? formatter.parse(queryParams.getFirst("facet.range.end")) : new Date(Long.MAX_VALUE);
